...
function inserisci ()
{
    ...
    else if (nomiEcognomi.indexOf(nodoDati[0].value) != -1)
    {
    ...
    else if (modificaCont == true)
    {
        ...
        // modifica anche l'array dei nomi e cognomi per fare una giusta verifica i ncaso di omonimia
        nomiEcognomi[numRecord] = nodoDati[0].value;
    ...
    nomiEcognomi.push(nuovoNomeEcognome);
    nodoDati[0].value="";
    nodoDati[1].value="";
    nodoDati[2].value="";
    nodoDati[3].value="";
...
function cancella(numeroRecord)
{
    ...
    nomiEcognomi.splice(numeroRecord,1);
